...
export const studentGunaItems = [
    ...
    { id: "R3", text: "When solving a problem, do you prefer to rely entirely on your own logic/modern methods rather than looking at how things were traditionally done?", category: "rajas", domain: "academic" },
    { id: "R4", text: "How often do you check your social media likes or exam grades and feel a sudden rush of pride or superiority?", category: "rajas", domain: "academic" },
    { id: "R7", text: "When you achieve a goal, how long does the 'high' last before you start looking for the next big thing?", category: "rajas", domain: "academic" },
    { id: "T6", text: "If you have a deadline in 3 days, do you start now, or wait until the night before (even if it stresses you out)?", category: "tamas", domain: "academic" },
    { id: "T7", text: "When faced with a complex problem, is your first instinct to try and solve it, or to freeze and wait for someone else to help?", category: "tamas", domain: "academic" },
    ...
    { id: "S4", text: "In a heated argument, how much effort do you make to keep your tone calm and avoid using harsh words?", category: "sattva", domain: "social" },
    ...
    { id: "R5", text: "Who do you follow/discuss more: Rich influencers & celebrities vs. Scientists & Social Workers?", category: "rajas", domain: "social" },
    ...
    { id: "T18", text: "When you talk to friends, how much of the conversation is you complaining about your problems vs. discussing ideas?", category: "tamas", domain: "social" },
    { id: "T19", text: "When a friend succeeds (gets a job/promotion), is your first feeling happiness for them, or a pang of 'Why not me?'", category: "tamas", domain: "social" },
    ...
    { id: "R10", text: "Given a free Friday night, would you rather go to a busy club/party or take a quiet walk in nature?", category: "rajas", domain: "lifestyle" },
    ...
    { id: "T10", text: "If you miss a bus or drop your coffee, does it ruin your entire morning?", category: "tamas", domain: "inner" },
    { id: "T13", text: "Do you often feel a vague sense of dread or anxiety about the future without knowing exactly why?", category: "tamas", domain: "inner" },
